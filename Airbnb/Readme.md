...
2.1: Identified top vacation rental properties

* Created a pivot table with top 10 neighborhoods
  
* Highlighted the top 10 neighborhoods by review count
...
2.2: Analyzed proeprty size preference and distribution
...
## Determine Occupancy
3.1: Explored weekly occupancy variations

* Built pivot table to analyze weekly occupancy

* Identified days with the highest occupancy rate

# Determine Return on Investment
4.1: Filtered properties based on criteria the investor finds necessary

* Investigated top 5 neighborhoods and corresponding property size

* Created pivot table to analyze average price and occupancy rate
